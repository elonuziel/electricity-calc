...
### Standalone Version
In the root of this project, you will find `electricity_calc_standalone.html`. This file is automatically generated by bundling all the components in this folder (HTML, CSS, and JS) into a single standalone file. It is the recommended version for daily use while this folder remains the primary workspace for development.
